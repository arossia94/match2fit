...
(* Routine to fix SM RGEs loop order *)
...
(* Routine to fix SMEFT RGEs loop order *)
SetSMEFTRGELoopOrder[n_]:=Block[{},
If[n==SMEFTRGELoopOrder,
Message[SetSMEFTRGELoopOrder::NoChange,n];
,
If[IntegerQ[n]&&1<=n<=2,
Unprotect[SMEFTRGELoopOrder];
SMEFTRGELoopOrder=n;
Protect[SMEFTRGELoopOrder];
BuildRGEs["SMEFT"];
,
Message[SetSMEFTRGELoopOrder::WrongOrder,n];
];
];
];
...
If[theory=="SMEFT",
RGEsSMEFT=Join[\[Beta]/@ParametersSMEFT[[1;;First[SMEFTFindParameter[Ge[3,3]]]]]/.ToLoopOrder[SMEFTLoopOrder]//Chop,\[Beta]/@ParametersSMEFT[[First[SMEFTFindParameter[Ge[3,3]]]+1;;-1]]/.ToLoopOrderSMEFT[SMEFTRGELoopOrder]//Chop];
RGEsSMEFTtPre=If[FileExistsQ[DsixToolsDir<>"RGEsSMEFT.mx"],Import[DsixToolsDir<>"RGEsSMEFT.mx"],Import[DsixToolsDir<>"RGEsSMEFT.m"]];
If[RGEsMethod==4,
RGEsSMEFTt=Join[RGEsSMEFTtPre[[1;;First[SMEFTFindParameter[Ge[3,3]]]]]/.ToLoopOrder[SMEFTLoopOrder]//Chop,RGEsSMEFTtPre[[First[SMEFTFindParameter[Ge[3,3]]]+1;;-1]]//Chop];
,
RGEsSMEFTt=Join[RGEsSMEFTtPre[[1;;First[SMEFTFindParameter[Ge[3,3]]]]]/.ToLoopOrder[SMEFTLoopOrder]//Chop,RGEsSMEFTtPre[[First[SMEFTFindParameter[Ge[3,3]]]+1;;-1]]/.ToLoopOrderSMEFT[SMEFTRGELoopOrder]//Chop];
